...
function implementPagination(selector, paginationClass, totalCount, pageCount){
	...
	if(totalCount > pageCount)
		$(selector).slice(pageCount).hide();
		$(paginationClass).jqPagination({
		    max_page: Math.ceil(totalCount / pageCount),
		   
		    paged: function (page) {
		        $(selector).hide();
		        $(selector).slice((page - 1) * pageCount, (page * pageCount)).show();
		    }
		});
