        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body"><div class="logo-heading"></div><div class="logo2-heading"></div>
                    ...
                    <h4 align="center">9810650437 -- 9437052071 -- 9350245283</h4><br/><br/>
                    <form:form  method="post" modelAttribute="user"  action="${pageContext.request.contextPath}/saveNewUser" name="addUserForm"  id="addUserForm" autocomplete="off" >
		                         ...
		                         <div class="input-group">
		                             <div class="rs-select2 js-select-simple select--no-search">
		                                 <form:select path="isMbrOfPps" required="required">
		                                     <form:option disabled="disabled" selected="selected" value="">User Type</form:option>
		                                     <form:option value="Y">Yes</form:option>
		                                     <form:option value="N">No</form:option>
		                                 </form:select>
		                                 <div class="select-dropdown"></div>
...
<%--                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
 									<form:input path="country" class="input--style-2" type="text" placeholder="Country" required="true"/>                                
 								</div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
