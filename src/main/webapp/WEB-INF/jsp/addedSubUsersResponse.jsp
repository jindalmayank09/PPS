            ...
            <div class="card card-2">
                ...
                <div class="card-body"><div class="logo-heading"></div><div class="logo2-heading"></div>
				    ...
				    <c:if test="${userObj.noOfMPrsns>1}">
				    	<h3 align="right"><a href="${pageContext.request.contextPath}/addSubUsers?userObj=${userObj.userId}_view&${userObj.creationTime}" style=" margin-right: 206px; ">View Sub Users Details</a></h3>
				    </c:if>
